...
:url-repo: https://github.com/hyperpolymath/asdf-gitleaks-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-gitleaks-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-gitleaks-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-gitleaks-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Gitleaks] versions.
...
Gitleaks is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Gitleaks versions per project

|**Project Isolation**
|Pin Gitleaks per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Gitleaks version
...
=== Installing Gitleaks Versions

[source,bash]
----
asdf list all gitleaks
asdf install gitleaks latest
asdf install gitleaks 0.1.0
----
...
[source,bash]
----
asdf global gitleaks 0.1.0
asdf local gitleaks 0.1.0
...
* Ensure `gitleaks` is on PATH after installation.
* Verify the installed version with `gitleaks --version`.
